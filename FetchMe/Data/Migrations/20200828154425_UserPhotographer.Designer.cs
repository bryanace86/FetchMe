...
namespace FetchMe.Data.Migrations
{
    ...
    [Migration("20200828154425_UserPhotographer")]
    partial class UserPhotographer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FetchMe.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<Guid>("UserBannerImageId")
            ...
            modelBuilder.Entity("FetchMe.Models.BlogModels.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FetchMe.Models.GalleryModels.Gallery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FetchMe.Models.GalleryModels.GalleryImage", b =>
                {
                    ...
                    b.HasKey("GalleryId", "PhotographId");
            ...
            modelBuilder.Entity("FetchMe.Models.PhotographModels.UserBannerImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserBannerImages");
                });

            modelBuilder.Entity("FetchMe.Models.PhotographModels.UserProfileImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FetchMe.Models.PostModels.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FetchMe.Models.SupportModels.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FetchMe.Models.SupportModels.SupportTicketResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FetchMe.Models.SupportModels.SupportTicketStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5be86e69-0ac0-4322-ae59-d9e4eaabfc9b"),
                            Status = "New"
                        },
                        new
                        {
                            Id = new Guid("eea30f4e-1d22-4aa0-94c2-6f2be2633bd0"),
                            Status = "Pending User Response"
                        },
                        new
                        {
                            Id = new Guid("d4919e2f-d00a-45e1-bff3-78e34ac98ea3"),
                            Status = "Pending Support Response"
                        },
                        new
                        {
                            Id = new Guid("8c108fb0-e003-4028-a9dc-48c5ee46936b"),
                            Status = "Closed"
                        });
                });
            ...
            modelBuilder.Entity("FetchMe.Models.BlogModels.Blog", b =>
                {
                    b.HasOne("FetchMe.Models.ApplicationUser", "User")
                        .WithMany("Blogs")
                        .HasForeignKey("OwnerId");

                    b.HasOne("FetchMe.Models.PhotographModels.Photograph", "Thumbnail")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("FetchMe.Models.GalleryModels.Gallery", b =>
                {
                    b.HasOne("FetchMe.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Galleries")
                        .HasForeignKey("OwnerID");
            ...
            modelBuilder.Entity("FetchMe.Models.GalleryModels.GalleryImage", b =>
                {
                    b.HasOne("FetchMe.Models.GalleryModels.Gallery", "Gallery")
            ...
            modelBuilder.Entity("FetchMe.Models.PhotographModels.UserBannerImage", b =>
                {
                    b.HasOne("FetchMe.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("UserBannerImage")
                        .HasForeignKey("FetchMe.Models.PhotographModels.UserBannerImage", "UserId");
                });
            ...
            modelBuilder.Entity("FetchMe.Models.PhotographModels.UserProfileImage", b =>
                {
                    b.HasOne("FetchMe.Models.ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("FetchMe.Models.PhotographModels.UserProfileImage", "UserId");
                });
            ...
            modelBuilder.Entity("FetchMe.Models.PhotographerModels.Photographer", b =>
                {
                    ...
                    b.HasOne("FetchMe.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("FetchMe.Models.PhotographerModels.Photographer", "OwnerID");
                });

            modelBuilder.Entity("FetchMe.Models.PostModels.Post", b =>
                {
                    b.HasOne("FetchMe.Models.BlogModels.Blog", "Blog")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("FetchMe.Models.SupportModels.SupportTicket", b =>
                {
                    b.HasOne("FetchMe.Models.SupportModels.SupportTicketStatus", "Status")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("FetchMe.Models.SupportModels.SupportTicketResponse", b =>
                {
                    b.HasOne("FetchMe.Models.SupportModels.SupportTicket", "Ticket")
                        .WithMany("Responses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FetchMe.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
