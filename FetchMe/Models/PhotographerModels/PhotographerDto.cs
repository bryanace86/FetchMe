...
namespace FetchMe.Models.PhotographerModels
{
    public class PhotographerDto
    {
        ...
        public virtual IEnumerable<PhotographDto> Photographs { get; set; }

        public virtual IEnumerable<PhotographerLocation> Locations { get; set; }

        public virtual IEnumerable<PhotographerLike> PhotographerLikes { get; set; }
        public virtual IEnumerable<PhotographerBadge> PhotographerBadges { get; set; }

        public bool IsLiked { get; set; }
        public object SubscribeToNewsletter { get; set; }
    }
}
